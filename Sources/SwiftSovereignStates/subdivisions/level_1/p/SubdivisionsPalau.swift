...
public enum SubdivisionsPalau : String, CaseIterable, SovereignStateSubdivision { // https://en.wikipedia.org/wiki/States_of_Palau
    ...
    public func getFlagURLWikipediaSVGID() -> String? {
        ...
        case .airai: return "d/d8/Flag_of_Airai_State.png/27px-Flag_of_Airai_State.png"
        case .melekeok: return "4/44/Flag_of_Melekeok.png/27px-Flag_of_Melekeok.png"
        case .ngaraard: return "4/45/Flag_of_Ngaraard_State"
        case .ngarchelong: return "9/9d/Flag_of_Ngarchelong"
        case .ngardmau: return "3/39/Flag_of_Ngardmau_State.png/27px-Flag_of_Ngardmau_State.png"
        case .ngeremlengui: return "d/dc/Flag_of_Ngeremlengui_State%2C_Palau"
        case .ngatpang: return "f/ff/Flag_of_Ngatpang"
        case .ngchesar: return "5/57/Flag_of_Ngchesar_State.png/27px-Flag_of_Ngchesar_State.png"
        case .ngiwal: return "7/7c/Flag_of_Ngiwal_State.png/27px-Flag_of_Ngiwal_State.png"
        case .angaur: return "8/86/Flag_of_Angaur_State"
        case .koror: return "1/1b/Flag_of_Koror_State.png/27px-Flag_of_Koror_State.png"
